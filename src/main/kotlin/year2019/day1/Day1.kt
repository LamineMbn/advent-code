...
//fun day2.day7.day3.day4.day5.day6.`2019`.main9`.main.kotlin.main(){
//    val fuelNeeded : Int = day1.getMasses.stream().mapToDouble(Int::toDouble).map { mass -> main.kotlin.calculateFuelOfFuel(mass) }.sum().toInt()
//
//    print(fuelNeeded)
//}
