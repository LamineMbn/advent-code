...
//fun day2.day7.day3.day4.day5.day6.day8.main(){
//    val fuelNeeded : Int = day1.getMasses.stream().mapToDouble(Int::toDouble).map { mass -> day1.calculateFuelOfFuel(mass) }.sum().toInt()
//
//    print(fuelNeeded)
//}
