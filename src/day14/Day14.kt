...
private val equations: List<String> = readFileLineByLineUsingForEachLine("src/day14/input_AoC_input_0.txt")

private val memberTransformer: MemberTransformer = MemberTransformer()
private val equationTransformer: EquationTransformer = EquationTransformer()
